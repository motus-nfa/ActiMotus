import numpy
import numpy as np
from functions.Motus_backend import motus_step2_4sensors
...
class ActivityMotus_v2_1_0_4sensors:
    """
    ...
    def analyse_data_list_new(
        ...
        ts_chunked, out_cat, out_val, out_ver = motus_step2_4sensors(
